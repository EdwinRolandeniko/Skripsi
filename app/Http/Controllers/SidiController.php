...
class SidiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'surat_baptis' => 'required|file|mimes:pdf|max:2048', 
        ]);
        ...
        return redirect()->route('sidi.umat')->with('success','Pendaftaran Berhasil Di Kirim, Silahkan Menunggu Hasil Validasi');
    }
    ...
    public function print()
    {
        ...
        $data = Sidi::with(['user' => fn ($q) => $q->with('lingkungan')])
            ...
            ->first();
        // dd($data);
        return view('umat.sidiPrint', compact('data','date'));
    }
}
