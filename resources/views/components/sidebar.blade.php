<div>
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark " id="sidenavAccordion" style="background-color: ##011b36">
            <div class="sb-sidenav-menu">
                <div class="nav fs-6"style="color: #ffffff">
                    {{-- <div class="sb-sidenav-menu-heading">Core</div> --}}
                    <a class="nav-link" href="{{ route('admin.dashboard') }}">
                        <div class="sb-nav-link-icon me-3"><i class="bi fs-5 bi-speedometer2" style="color: #e9ecf0"></i>
                        </div>
                        Dashboard
                    </a>
                    <hr>
                    ...
                    <a class="nav-link" href="{{ route('sidi.index') }}">
                        ...
                        Sidi/Katekisasi <span class="badge badge-warning bg-warning ms-auto my-auto">{{ $sidi }}</span>
                    </a>
