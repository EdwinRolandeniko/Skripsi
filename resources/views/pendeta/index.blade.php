    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" id="mainNav">
        <div class="container d-flex">
            <div class="" style="height: 50px">
                <a class="d-flex" href="{{ route('pendeta.dashboard') }}" style="height: 100%; text-decoration: none">
            ...
            <div class="my-auto">
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto  py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('jadwal-halangan.pendeta') }}">Jadwal Halangan</a></li>
                        
                        
                        @if (Auth::check())
                        <li class="nav-item dropdown">
                                <a class="nav-link" href="/pendeta/akun">
                                    {{ Auth::user()->nama }}
                                </a>
