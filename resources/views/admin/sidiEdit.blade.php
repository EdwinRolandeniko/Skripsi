...
@section('content-admin')
    <div class="container">
        <div class="card">
            <div class="card-header">Validasi Katekisasi</div>
                ...
                <form method="POST" action="{{ route('sidi.update', $data->id) }}">
                    ...
                    <div class="form-group my-2">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="my-3 p-2 border border-1">
                                <embed id="previewPdf"
                        ...
                        <div class="form-group my-2">
                            <label for="inputRole">Status Anggota Katekisasi</label>
                            <select class="form-select" aria-label="Default select example" name="status" id="inputRole">
                                <option value="null" disabled>Pilih Status Pengajuan Anggota Katekisasi
                                </option>
